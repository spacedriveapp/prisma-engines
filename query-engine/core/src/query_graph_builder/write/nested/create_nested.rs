...
pub fn nested_create_many(
    ...
    let data_list: ParsedInputList<'_> = utils::coerce_vec(obj.shift_remove(args::DATA).unwrap());
    let skip_duplicates: bool = match obj.shift_remove(args::SKIP_DUPLICATES) {
